...
public interface ReviewMapper {
    ...
    Review reviewDtoToReview(ReviewDto reviewDto, RecipeService recipeService, UserService userService) throws InvalidArgumentsException, ObjectDoesntExistException;
