...
public class RecipeControllerImpl implements RecipeController {
    ...
    public ResponseEntity<Boolean> addNewRecipe(@RequestPart("recipe") RecipeDto recipeDto, @RequestPart("image") MultipartFile image) throws IOException, InvalidArgumentsException {
